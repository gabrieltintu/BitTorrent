...
function test1 {
	...
	cp tests/test1/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 4 ./bit_torrent"
...
function test2 {
	...
	cp tests/test2/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 6 ./bit_torrent"
...
function test3 {
	...
	cp tests/test3/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 5 ./bit_torrent"
...
function test4 {
	...
	cp tests/test4/* .
	correct=0
	run_timeout "mpirun --oversubscribe -np 7 ./bit_torrent"
	compare_files client3_file1 out1.txt
